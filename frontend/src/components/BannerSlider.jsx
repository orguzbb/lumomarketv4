...
const BannerSlider = () => {
  ...
  return (
    ...
    >
      {/* Slider Content */}
      <div className={`w-full min-h-[320px] sm:min-h-[380px] md:min-h-[420px] bg-gradient-to-r ${bgGradient} flex items-center justify-between p-6 sm:p-10 md:p-12 transition-all duration-700 ease-in-out`}>
        {/* Left Text Portion */}
        <div className="max-w-lg space-y-4 z-10">
          ...
          {/* CTA Button */}
          <div className="pt-2">
            <button className={`px-6 py-3 rounded-xl font-bold text-sm shadow-md transition-all transform hover:scale-[1.02] active:scale-[0.98] ${buttonBg}`}>
              Batafsil ko'rish
            </button>
          </div>
        </div>
